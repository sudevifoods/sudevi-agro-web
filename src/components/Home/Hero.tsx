    ...
    <section className="relative bg-sudevi-red text-white overflow-hidden h-[90vh]">
      ...
      <div className="container mx-auto px-4 py-20 lg:py-32 relative z-10 flex items-center h-full">
        <div className="max-w-3xl">
          <h1 
            className="text-4xl md:text-5xl lg:text-7xl font-bold mb-6 text-white animate-fade-in"
            style={{ animationDelay: '0.2s' }}
          >
            Taste The Tradition
          </h1>
          <p 
            className="text-xl md:text-2xl mb-8 text-white animate-fade-in"
          ...
          >
            <Button 
              asChild 
              size="lg" 
              className="bg-white text-sudevi-red hover:bg-gray-100 rounded-md transition-transform hover:scale-105"
            >
            ...
            <Button 
              ...
              variant="outline" 
              size="lg" 
              className="border-white text-white hover:bg-white hover:text-sudevi-red bg-transparent rounded-md transition-transform hover:scale-105"
            >
